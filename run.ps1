...
chcp 65001 | Out-Null
Write-Host "[MUD] Starting Practice MUD with DevTools JDK 25 and Maven 3.9.16..." -ForegroundColor Cyan
& "C:\Workspace\DevTools\apache-maven-3.9.16\bin\mvn.cmd" spring-boot:run
